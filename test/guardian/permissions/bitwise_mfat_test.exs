defmodule Guardian.Permissions.BitwiseTestMFAT do
  ...
  describe "any_permissions? with timeout" do
    test "Should exit .... "
    pid = self()
    ImplT.any_permissions?(%{user: [:read, :write]}, %{user: [:read]})
